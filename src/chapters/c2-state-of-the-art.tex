...
"The encryption algorithm is 128 Advanced Encryption Standard (AES\abbrev{AES}{Advanced Encryption Standard}) with chained block cipher (CBC) and ESSIV:SHA256.\abbrev{ESSIV}{Encrypted salt-sector initialization vector}\abbrev{SHA}{Secure Hash Algorithm} The master key is encrypted with 128-bit AES via calls to the OpenSSL library. 128 bits or more must be used for the key\footnote{\url{https://source.android.com/devices/tech/security/encryption/}}."
